    ...
    def frame_creator(self):
        ...
        if self.number == 1:
            ...
            if Frame3.col == 0:
                ...
                Frame3.max_above = len(self.above.split(","))
                Frame3.max_left = 0
            else:
        ...
        # Ensuring coordinate is in bound.
        if Frame3.row > 2:
            Frame3.row = 2
        if Frame3.row < 0:
            Frame3.row = 0
        ...
        self.coordinate = str(Frame3.row) + "," + str(Frame3.col)
